      ...
      <div className="header">
        <div className="nav-bar">
          ...
          <div className="nav">
            ...
            <nav>
              <button className="close" id="close-nav">
                <i className="fa-solid fa-x"></i>
              </button>
              <ul>
                <li>
                  <Link to="/Hombre" title="hombre">
                    Hombre <i className="fa-solid fa-angle-right"></i>
                  </Link>
                </li>
                <li>
                  <Link to="/Mujer" title="mujer">
                    Mujer <i className="fa-solid fa-angle-right"></i>
                  </Link>
                </li>
                <li>
                  <Link to="/Niño" title="niño">
                    Niño/a <i className="fa-solid fa-angle-right"></i>
                  </Link>
                </li>
                {/* <li><Link to= "" title="ofertas" >Ofertas <i className="fa-solid fa-angle-right"></i></Link></li> */}
                <li>
                  <Link to="/Tecnologia" title="tecnología">
                    Tecnología <i className="fa-solid fa-angle-right"></i>
                  </Link>
                </li>
              </ul>
              <div className="preguntas">
                <button title="ayuda">
                  Ayuda <i className="fa-solid fa-circle-question"></i>
                </button>
              </div>
              <div className="iniciar-sesion">
                <button title="registrarse" className="register">
                  Registrarse
                </button>
                <button title="iniciar sesion" className="sing-up">
                  Iniciar Sesión
                </button>
              </div>
            </nav>
            ...
            <CartList
              myOnClick={desactivarCart}
              myCondition={visibilityCart}
              mySetFn={setVisibilityCart}
              other={"nav-carrito"}
            />
            <HeartList
              myOnClick={desactivarHeart}
              myCondition={visibilityHeart}
              other={"nav-heart"}
            />
          </div>
          <div className="search-heart-car">
            ...
            <button className="menu-hamburguesa">
              ...
              >
                <path
                  d="M26.25 22.5H11.25V20H26.25V22.5ZM26.25 16.25H3.75V13.75H26.25V16.25ZM26.25 10H11.25V7.5H26.25V10Z"
                  fill="black"
                />
              </svg>
            </button>
